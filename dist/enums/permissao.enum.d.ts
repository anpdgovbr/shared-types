 ...
 */
export type AcaoPermissao = 'Exibir' | 'VerHistorico' | 'EditarProprio' | 'EditarGeral' | 'Alterar' | 'Cadastrar' | 'Editar' | 'Desabilitar' | 'Criar';
/**
 * Recursos do sistema que podem ter permissões atribuídas
 */
export type RecursoPermissao = 'Processo' | 'Responsavel' | 'Metadados' | 'Relatorios' | 'Permissoes' | 'Usuario';
/**
